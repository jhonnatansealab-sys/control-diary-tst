...
const required = [
  ...
  ["src/pages/Schedule.tsx", /StatusObservationModal/],
  ["src/pages/Schedule.tsx", /schedule-filter-controls/],
  ["src/pages/Schedule.tsx", /Observação da mudança/],
  ["src/pages/Schedule.tsx", /Histórico de mudanças/],
  ["src/pages/Schedule.tsx", /changeHistory/],
  ...
  ["src/App.tsx", /createScheduleChangeLog/],
  ...
  ["src/types.ts", /ScheduleChangeLog/],
  ["src/types.ts", /changeHistory/],
  ...
  ["supabase/functions/diary-api/index.ts", /Informe a observacao da mudanca de status/],
  ["supabase/functions/diary-api/index.ts", /createScheduleLog/],
